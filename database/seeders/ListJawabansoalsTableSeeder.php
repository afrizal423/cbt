...
class ListJawabansoalsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        \DB::table('list_jawabansoals')->delete();
        
        \DB::table('list_jawabansoals')->insert(array (
            0 => 
            array (
                'id' => '01g735fxawn2jx7g1r6xywtpsw',
                'type_jawaban' => 'pilgan',
                'text_jawaban' => '"<p>Catat poin informasi<\\/p>\\n"',
                'soal_id' => '01g735fxanwmxsydzh8yqbd6f3',
                'keyPilgan' => '01g735cwq6v85ttd741et0pk3n',
            ),
            1 => 
            array (
                'id' => '01g735fxb0dr7mrnq2v02sgvjh',
                'type_jawaban' => 'pilgan',
                'text_jawaban' => '"<p>lewati topik<\\/p>\\n"',
                'soal_id' => '01g735fxanwmxsydzh8yqbd6f3',
                'keyPilgan' => '01g735cwq75ad330b3mrtmfzsp',
            ),
            2 => 
            array (
                'id' => '01g735fxb2rftg4f4qmf82kp29',
                'type_jawaban' => 'pilgan',
                'text_jawaban' => '"<p>Abaikan pesan informasi<\\/p>\\n"',
                'soal_id' => '01g735fxanwmxsydzh8yqbd6f3',
                'keyPilgan' => '01g735cwq8r55q8f6v5s62se2b',
            ),
            3 => 
            array (
                'id' => '01g735fxb5rbapmkpvycnahex9',
                'type_jawaban' => 'pilgan',
                'text_jawaban' => '"<p>Ubah informasinya<\\/p>\\n"',
                'soal_id' => '01g735fxanwmxsydzh8yqbd6f3',
                'keyPilgan' => '01g735cwq9hbt809jfgdbhtpxv',
            ),
            4 => 
            array (
            ...
            array (
                ...
                'type_jawaban' => 'pilgan',
                'text_jawaban' => '"<p>Komputer sangat bermanfaat bagi manusia<\\/p>\\n"',
                'soal_id' => '01g732vctje9f7j72xj5m1hj7k',
            ...
            array (
                ...
                'type_jawaban' => 'pilgan',
                'text_jawaban' => '"<p>Komputer membantu orang mengetik<\\/p>\\n"',
                'soal_id' => '01g732vctje9f7j72xj5m1hj7k',
            ...
            array (
                ...
                'type_jawaban' => 'pilgan',
                'text_jawaban' => '"<p>Semua pekerjaan bisa dilakukan dengan cepat<\\/p>\\n"',
                'soal_id' => '01g732vctje9f7j72xj5m1hj7k',
            ...
            array (
                ...
                'type_jawaban' => 'pilgan',
            'text_jawaban' => '"<p>(1) &ndash; (2) &ndash; (3) &ndash; (4)<\\/p>\\n"',
            ...
            array (
                ...
                'type_jawaban' => 'pilgan',
            'text_jawaban' => '"<p>(3) &ndash; (4) &ndash; (1) &ndash; (2)<\\/p>\\n"',
                'soal_id' => '01g7330hg18mh4mt8x5zt9xqvp',
            ...
            array (
                ...
                'type_jawaban' => 'pilgan',
            'text_jawaban' => '"<p>(2) &ndash; (3) &ndash; (1) &ndash; (4)<\\/p>\\n"',
                'soal_id' => '01g7330hg18mh4mt8x5zt9xqvp',
            ...
            array (
                ...
                'type_jawaban' => 'pilgan',
            'text_jawaban' => '"<p>(4) &ndash; (3) &ndash; (2) &ndash; (1)<\\/p>\\n"',
                'soal_id' => '01g7330hg18mh4mt8x5zt9xqvp',
            ...
            array (
                ...
                'type_jawaban' => 'pilgan',
                'text_jawaban' => '"<p>sebuah pertanyaan<\\/p>\\n"',
                'soal_id' => '01g7333r7d726ryh3twg5q38jm',
            ...
            array (
                ...
                'type_jawaban' => 'pilgan',
                'text_jawaban' => '"<p>Melakukan sesuatu harus disertai dengan antusiasme<\\/p>\\n"',
            ...
            array (
                ...
                'type_jawaban' => 'pilgan',
                'text_jawaban' => '"<p>Didampingi oleh ketabahan, kesuksesan bisa diraih<\\/p>\\n"',
                'soal_id' => '01g7335jr5y1bs76ge2te5efb3',
            ...
            array (
                ...
                'type_jawaban' => 'pilgan',
                'text_jawaban' => '"<p>Mencoba sesuatu harus berjalan seiring dengan doa<\\/p>\\n"',
                'soal_id' => '01g7335jr5y1bs76ge2te5efb3',
